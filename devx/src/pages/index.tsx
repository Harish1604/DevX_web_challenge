...
const eras = [
  {
    ...
    year: "1990-1999",
    description:
      "The early web was characterized by simple HTML, table-based layouts, and animated GIFs.",
  ...
  },
  {
    ...
    year: "2000-2012",
    description:
      "Digital interfaces mimicked real-world objects with detailed textures and 3D effects.",
    features: [
      "3D Effects",
      "Glossy Buttons",
      "Flash Animations",
  ...
  },
  {
    ...
    year: "2013-Present",
    description:
      "Clean, flat designs with focus on typography, white space, and subtle animations.",
    features: [
      "Flat Design",
      "Large Typography",
      "Microinteractions",
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (heroSectionRef.current) {
        heroSectionRef.current.style.transform = `translateY(${
          window.scrollY * 0.3
        }px)`;
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 text-white overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-12 relative">
          ...
          <h1
            className="text-5xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 mb-4 animate-slide-up"
            style={{ animationDelay: "0.2s" }}
          >
            Evolution of UI
          </h1>
          <p
            className="text-lg text-gray-300 max-w-2xl mx-auto animate-slide-up"
            style={{ animationDelay: "0.4s" }}
          >
            Experience the transformation of web design across different eras
      ...
      <div className="relative py-32 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p
              className="text-gray-300 max-w-2xl mx-auto animate-slide-up"
              style={{ animationDelay: "0.2s" }}
            >
              Click on different eras to see how web design has evolved over the
              decades.
            </p>
          </div>
          ...
          >
            ...
            <div className="flex justify-between">
              {eras.map((era, index) => (
                <div
                  key={era.id}
                  className={`relative pb-8 transition-all duration-500 ease-in-out ${
                    index === activeEra
                      ? "scale-110"
                  ...
                  >
                    <div
                      className={`text-white ${
                        index === activeEra ? "animate-pulse-slow" : ""
                      }`}
                    >
                      {era.icon}
                    </div>
                  ...
                  <div className="absolute top-full left-1/2 -translate-x-1/2 w-max text-center pt-4">
                    ...
                    <div
                      className={`text-sm transition-all duration-300 ${
                        index === activeEra ? "text-blue-300" : "text-gray-500"
                      }`}
                    >
                      {era.year}
                    </div>
                      ...
                      {activeEra === 0 && (
                        <div className="pixel-border bg-white p-8 animate-float shadow-xl">
                          <div className="text-black text-center">
                            <div className="bg-era90s-primary text-white font-bold p-2 mb-4">
                              WELCOME!
                            </div>
                            <div className="grid grid-cols-3 gap-2">
                              {Array(3)
                                ...
                                .map((_, i) => (
                                  <div
                                    key={i}
                                    className="h-12 w-full bg-gray-200 flex items-center justify-center"
                                  >
          ...
          <div className="flex justify-center mt-12 gap-4">
            <Button
              ...
              size="lg"
              onClick={() =>
                changeEra(activeEra > 0 ? activeEra - 1 : eras.length - 1)
              }
            ...
            <Button
              ...
              size="lg"
              onClick={() =>
                changeEra(activeEra < eras.length - 1 ? activeEra + 1 : 0)
              }
              className="bg-white/10 border-white/20 hover:bg-white/20 backdrop-blur-sm"
            >
              Next Era
      ...
      <div className="py-24 px-4 relative">
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h2 className="text-3xl md:text-5xl font-bold mb-6 animate-slide-up">
            Ready to Explore UI Evolution?
          </h2>
          <p
            className="text-xl text-gray-300 mb-8 animate-slide-up"
            style={{ animationDelay: "0.2s" }}
          >
            Dive deeper into the history of web design and see how digital
            interfaces have changed our lives.
          </p>
          <Button
            size="lg"
